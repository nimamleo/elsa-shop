...
export class Product1732220406698 implements MigrationInterface {
  name = 'Product1732220406698';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "basket" ("id" BIGSERIAL NOT NULL, "userId" bigint NOT NULL, "productId" bigint NOT NULL,  "count" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "infoId" bigint, CONSTRAINT "PK_895e6f44b73a72425e434a614cc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "info" ("id" BIGSERIAL NOT NULL, "colorId" bigint NOT NULL, "sizeId" bigint NOT NULL, "count" integer NOT NULL, "productId" bigint NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_687dc5e25f4f1ee093a45b68bb7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "info" ADD CONSTRAINT "FK_0f6654094346d4ebb23ac07203b" FOREIGN KEY ("colorId") REFERENCES "size"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
